...
typealias CheatType = String

struct CheatFormat: Hashable {
    let name: String
    ...
    init(name: String, format: String, type: CheatType, allowedCodeCharacters: CharacterSet = CharacterSet.hexadecimals) {
        self.name = name
        self.format = format
        self.type = type
